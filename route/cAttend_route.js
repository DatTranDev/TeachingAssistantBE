...
route.get(
  ...
  auth,
  paginate(50),
  cAttendController.findBySubjectId,
);
...
route.post(
  "/attendRecord/add/forStudent",
  auth,
  attendRecordController.addForStudent,
);
route.patch(
  "/attendRecord/update/forStudent/:id",
  auth,
  attendRecordController.updateForStudent,
);
route.patch(
  "/attendRecord/markExcusedAttendance",
  auth,
  attendRecordController.markExcusedAttendance,
);
route.get(
  "/attendStudents/:cAttendId",
  auth,
  cAttendController.getAttendStudent,
);
route.patch("/reset/:cAttendId", auth, cAttendController.resetAttendance);
route.patch(
  "/resetSingle/:cAttendId/:index",
  auth,
  cAttendController.resetSingleAttendance,
);
route.patch(
  "/updateAcceptedNumber/:cAttendId",
  auth,
  cAttendController.updateAcceptedNumber,
);

route.get(
  "/topParticipants/:cAttendId",
  auth,
  cAttendController.getTopParticipants,
);
