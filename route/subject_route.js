...
} = require("../validators/subject.validator.js");
...
route.get(
  "/:subjectId/user/:userId/attendRecords",
  attendRecordController.findByUserAndSubject,
);
route.get(
  "/:subjectId/user/:userId/reviews",
  reviewController.findBySubjectAndUser,
);
route.get("/:subjectId/students", subjectController.getStudents);
route.get(
  "/:subjectId/students/exportExcel",
  fileGenerateController.getStudentList,
);

route.post(
  "/notify/classCancel",
  auth,
  subjectController.notifyClassCancellation,
);
route.post(
  "/notify/classReschedule",
  auth,
  subjectController.notifyClassReschedule,
);

route.get(
  "/top-participants/:subjectId",
  auth,
  subjectController.getTopParticipants,
);
...
route.get(
  "/top-absentees/:subjectId",
  auth,
  subjectController.getTopAbsentStudents,
);
route.get("/getStats", auth, subjectController.getSubjectStats);
